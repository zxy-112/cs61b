...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    private void swim(int index) {
        ...
        if (parent != null) {
            if (parent.priority() > getNode(index).priority()) {
    ...
    private void sink(int index) {
        ...
        if (leftChild == null && rightChild != null) {
            if (rightChild.priority() < curNode.priority()) {
            ...
            if (leftChild.priority() <= rightChild.priority() && leftChild.priority() < curNode.priority()) {
                swap(index, leftIndex(index));
                sink(leftIndex(index));
            } else if (rightChild.priority() < leftChild.priority() && rightChild.priority() < curNode.priority()) {
                swap(index, rightIndex(index));
                sink(rightIndex(index));
            }
        }
